...
def delete_sale(conn, sale_id, restore_stock=True):
    ...
    try:
        with safe_transaction(conn):
            ...
            # Audit
            audit.log_action(conn, 'DELETE', 'sales', sale_id, old_data, None, commit=False)
        return True
    except Exception:
        raise
        ...
        with safe_transaction(conn):
            ...
            if old_status and old_status != new_status:
                audit.log_action(conn, 'UPDATE', 'commission_orders', order_id, 
                    {'status': old_status}, {'status': new_status}, commit=False)
        return True
    except Exception as e:
...
def delete_commission_order(conn, order_id):
    ...
    try:
        with safe_transaction(conn):
            ...
            audit.log_action(conn, 'DELETE', 'commission_orders', order_id, old_data, None, commit=False)
        return True
    except Exception as e:
...
def delete_commission_item(conn, order_id, item_id, product_id, quantity, 
    ...
    try:
        with safe_transaction(conn):
            ...
            audit.log_action(conn, 'DELETE', 'commission_items', item_id, old_data, None, commit=False)
    ...
    try:
        with safe_transaction(conn):
            ...
            if old_order_status != new_status:
                audit.log_action(conn, 'UPDATE', 'commission_orders', order_id, 
                    {'status': old_order_status}, {'status': new_status}, commit=False)
            ...
            audit.log_action(conn, 'UPDATE', 'commission_items', item_id, 
                {'quantity_produced': old_qty_produced}, {'quantity_produced': old_qty_produced + amount}, commit=False)
    ...
    try:
        with safe_transaction(conn):
            ...
            if old_order_status == 'Pendente':
                ...
                audit.log_action(conn, 'UPDATE', 'commission_orders', order_id, 
                    {'status': 'Pendente'}, {'status': 'Em Produção'}, commit=False)
...
def deliver_order(conn, order_id, order_data, items_df):
    ...
    try:
        with safe_transaction(conn):
            ...
            audit.log_action(conn, 'UPDATE', 'commission_orders', order_id, 
                {'status': old_status}, {'status': 'Entregue'}, commit=False)
        return True
    except Exception as e:
...
def delete_quote(conn, quote_id):
    ...
    try:
        with safe_transaction(conn):
            ...
            audit.log_action(conn, 'DELETE', 'quotes', quote_id, None, None, commit=False)
        return True
    except Exception as e:
